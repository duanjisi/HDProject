...
//            if (!name.equals(PrinterLogger.class.getName()) && !name.equals(Logger.class.getName())) {
            if (!name.equals("com.orhanobut.logger.PrinterLogger") && !name.equals(Logger.class.getName())) {
                return --i;
            }
        }
        return -1;
